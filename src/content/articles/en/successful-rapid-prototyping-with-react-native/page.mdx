...
import prototypes from './prototypes.png';
...
export const article = {
  ...
  canonical:
    'https://perttu.dev/articles/successful-rapid-prototyping-with-react-native',
  date: '2019-12-29',
  updated: '2025-12-02',
...
export const metadata = {
  ...
  openGraph: {
    ...
    title: article.title,
    description: article.description,
    url: 'https://perttu.dev/articles/successful-rapid-prototyping-with-react-native',
...
This is a transcript of a lightning talk I gave at React Day Berlin in 2019. You can watch the talk [here](https://www.youtube.com/embed/QafikEOSUGA). All the links resources are available at the end of this transcript.
...
<Image src={prototypes} alt='Three prototypes I build' />
...
<Image src={hack} alt='Analytics hack' />
