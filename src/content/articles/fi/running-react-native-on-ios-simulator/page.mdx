...
export const article = {
  ...
  canonical:
    'https://perttu.dev/articles/running-react-native-on-ios-simulator',
  date: '2019-10-31',
...
export const metadata = {
  ...
  openGraph: {
    ...
    title: article.title,
    description: article.description,
    url: 'https://perttu.dev/articles/running-react-native-on-ios-simulator',
